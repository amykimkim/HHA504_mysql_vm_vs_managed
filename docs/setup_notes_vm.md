...
8. After successfully running the python script in VS code, I was able to verify within my SSH again that the database  'tempdata' had the 'visits' table and data added into it.